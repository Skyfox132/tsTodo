  ...
  return (
    <div className="timer-container">
      ...
      <div className='buttons'>
        {
          !isCounting ? (
          <button className='btn create-btn' onClick = {handleStart}>Start</button>
          ) : (
          <button className='btn create-btn' onClick = {handlePause}>Pause</button>
          )
        }
        <button className='btn create-btn' onClick = {handleReset}>Reset</button>
      </div>
    </div>
  )
}
